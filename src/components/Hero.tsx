...
export default function Hero() {
  ...
  return (
    <section id="home" className="relative isolate w-full overflow-hidden bg-deep">
      {/* ---------- artwork ---------- */}
          ...
          <div className="max-w-xl lg:max-w-2xl">
            ...
            >
              ...
              <span className="relative inline-block">
                <span className="bg-gradient-to-r from-green via-leaf to-green bg-clip-text text-transparent">
                  Better Tomorrow.
                </span>
                <span
                  aria-hidden="true"
            ...
            <p
              {...reveal(280)}
              className="text-pretty mt-6 max-w-lg text-[0.95rem] leading-relaxed text-ink/75 sm:text-lg"
            >
              Modern poultry farming built on quality production, responsible care,
              strong biosecurity, and sustainable growth.
            </p>

            <div {...reveal(400)} className="mt-8 flex flex-wrap items-center gap-3 sm:gap-4">
              <a
                href="#farm"
